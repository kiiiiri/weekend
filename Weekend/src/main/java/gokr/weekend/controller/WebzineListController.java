...
//        ServletContext application = getServletContext();
        ...
        int pageSize = 7; // 한페이지에 출력할 글의 갯수
        ...
        List<WebzineDTO> boardLists = dao.selectListPage(map);  // 게시물 목록 받기
        dao.close(); // DB 연결 닫기

        // 뷰에 전달할 매개변수 추가
        // 1.2.3.4.5 페이지번호 생성
        String pagingImg = BoardPage.pagingStr(totalCount, pageSize, blockPage, pageNum, "/webzine/list.do");  // 바로가기 영역 HTML 문자열
